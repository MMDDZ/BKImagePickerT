//
//  BKIPPreviewTransitionAnimater.m
//  BKImagePicker
//
...
@interface BKIPPreviewTransitionAnimater()

@property (nonatomic,assign) BKShowExampleTransition type;

@end

@implementation BKIPPreviewTransitionAnimater
...
- (void)pushAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    BKIPPreviewViewController * toVC = (BKIPPreviewViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
...
- (void)popAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    BKIPPreviewViewController * real_fromVC = nil;
    if ([fromVC isKindOfClass:[UINavigationController class]]) {
        real_fromVC = (BKIPPreviewViewController*)[((UINavigationController*)fromVC).viewControllers firstObject];
        fromVC.view.backgroundColor = [UIColor colorWithWhite:1 alpha:0];
    }else{
        real_fromVC = (BKIPPreviewViewController*)fromVC;
    }
